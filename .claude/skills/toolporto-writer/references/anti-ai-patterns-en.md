...
Based on `content-deai-engine` skill (29 patterns, Wikipedia WikiProject AI Cleanup methodology, 4-step rewrite + 3-role review process), adapted for English AI tool review content.
